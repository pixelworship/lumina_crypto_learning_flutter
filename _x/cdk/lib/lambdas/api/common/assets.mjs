 ...
 *
 * The events table is intentionally schema-light: any string the client
 * wants to store is fine, but we still gate on a sane format so an
 * empty/garbled value never lands in `chart_events.asset` and starts
 * polluting filtered queries. Catalog membership is a UI affordance
 * (see `/v1/assets`), not an authorization check.
 */
